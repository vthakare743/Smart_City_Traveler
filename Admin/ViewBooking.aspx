<%@ Page Language="C#" AutoEventWireup="true" CodeFile="~/Admin/ViewBooking.aspx.cs" Inherits="Registration" %>
...
<div class="container">
    ...
    <div class="card">
        <h1 class="title"><span></span>View Booking</h1>
        <div class="col-md-12">
           ...
           <div class="input-group">
                ...
                <div class="form-line">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4"  DataSourceID="SqlDataSource1" ForeColor="Black" GridLines="Vertical" Width="100%" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
                        ...
                        <Columns>
                              <asp:CommandField ButtonType="Button" HeaderText="View Details" SelectText="Details" ShowSelectButton="True" ControlStyle-CssClass="btn btn-sm" ControlStyle-BackColor="#7cb9e8"/>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ParkingAppDBConnectionString %>" SelectCommand="SELECT * FROM [ParkingMaster] ">
