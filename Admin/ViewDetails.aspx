<%@ Page Language="C#" AutoEventWireup="true" CodeFile="~/Admin/ViewDetails.aspx.cs" Inherits="Registration" %>
        ...
        <div class="col-md-12">
           ...
           <div class="input-group">
                ...
                <div class="form-line">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ParkingAppDBConnectionString %>" SelectCommand="SELECT [customer], [mode], [bdate], [carno] FROM [BookMaster] WHERE ([pname] = @pname)">
                        <SelectParameters>
