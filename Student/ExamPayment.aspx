<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="ExamPayment.aspx.cs" Inherits="Registration" %>
...
<div class="container">
  ...
  <div class="input-group">
             ...
             <div class="form-line">
                    ...
                    <asp:DropDownList ID="DropDownList1" runat="server" Height="25px" Width="129px">
            ...
            <div class="input-group">
             ...
             <div class="form-line">
              ...
              <asp:TextBox ID="txtFees"  class="form-control" placeholder="Enter Fees Name" runat="server"></asp:TextBox>
             </div>
                    </div>
