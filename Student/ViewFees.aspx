<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewFees.aspx.cs" Inherits="Registration" %>
...
<div class="container">
    ...
    <div class="card">
        <h1 class="title"><span></span>View Payment</h1>
        <div class="col-md-12">
           ...
           <div class="input-group">
                ...
                <div class="form-line">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:StudentFeesDBConnectionString %>" SelectCommand="SELECT [pid],[fees], [mode],[category] FROM [FeesMaster] WHERE ([year] = @year)">
                        <SelectParameters>
