<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CheckSlots.aspx.cs" Inherits="StudentLogin" %>
...
<div class="container">
    ...
    <div class="card">
        <h1 class="title">Check Slots <asp:Image ID="Image1" Width="50px" ImageUrl="~/Images/CheckSlot.png" runat="server" /></h1>
        <div class="col-md-12">
