<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CheckSlotsSuccess.aspx.cs" Inherits="StudentLogin" %>
...
<div class="container">
    ...
    <div class="card">
        <h1 class="title">Vacant Slots <asp:Image ID="Image1" Width="50px" ImageUrl="~/Images/CheckSlot.png" runat="server" /></h1>
        <div class="col-md-12">
            <form id="sign_in" runat="server" method="POST">
                <div>
                    <div class="form-line">
                        <asp:Image ID="Image2" Height="150px" Width="100%" ImageUrl ="~/Images/parkingSlots.jpg" runat="server" />
                    </div>
                </div>
                <br />
                ...
                <span class="input-group-addon">
                    ...
                    <div class="form-line">
                        <asp:Label ID="lbltest" runat="server" Font-Size="Larger" ForeColor="Red" Text="Vacant Slots :"></asp:Label>
                    </div>
                </div>
                <br />
             ...
             <div class="form-line">
                 ...
                 <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ParkingAppDBConnectionString %>" SelectCommand="SELECT [pname], [TotalSlots], [RemainingSlots] FROM [ParkingMaster] WHERE ([narea] LIKE '%' + @narea + '%')">
                     <SelectParameters>
