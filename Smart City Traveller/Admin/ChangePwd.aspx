<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="ChangePwd.aspx.cs" Inherits="Admin_ChangePwd" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table style="width: 100%;">
        <tr  class="tbl-header">
            <td class="inner-head" colspan="2">
    ...
    <asp:SqlDataSource ID="sqlpwd" runat="server" 
        ...
        DeleteCommand="DELETE FROM [AdminReg] WHERE [username] = @UserID" 
        InsertCommand="INSERT INTO [AdminReg] ([username], [Pwd]) VALUES (@UserID, @Pwd)" 
        SelectCommand="SELECT [username], [Pwd] FROM [AdminReg]" 
        UpdateCommand="UPDATE [AdminReg] SET [Pwd] = @Pwd WHERE [username] = @UserID">
        <DeleteParameters>
