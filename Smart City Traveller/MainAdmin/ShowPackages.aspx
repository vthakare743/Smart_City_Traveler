<%@ Page Title="" Language="C#" MasterPageFile="~/MainAdmin/MainAdminMasterPage.master" AutoEventWireup="true" CodeFile="ShowPackages.aspx.cs" Inherits="MainAdmin_ShowPackages" %>
    ...
    <tr>
        <td>
            ...
            <asp:SqlDataSource ID="SqlDataGetData" runat="server" 
                    ...
                    SelectCommand="SELECT [id], [pname], [location], [duration], [cost], [photo] FROM [Packages] WHERE  status='Active'" 
