...
public partial class user_ViewDetails : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
       ...
       //Response.Write("Date : "+getFeedback_Allow_Date()+" Allow : "+checkUserBlockTime(getFeedback_Allow_Date()));
    ...
    protected void btnBook_Click(object sender, EventArgs e)
    {
        ...
        //SqlDataInsertBook.Insert();
       // ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Congratulations ! You Package Successfully')", true);
