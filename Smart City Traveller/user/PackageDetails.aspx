<%@ Page Title="" Language="C#" MasterPageFile="~/user/UserMasterPage.master" AutoEventWireup="true" CodeFile="PackageDetails.aspx.cs" Inherits="user_PackageDetails" %>
        ...
        <tr>
            <td>
                <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" 
                    ...
                    ForeColor="#333333" GridLines="None" Height="364px" Width="295px">
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    SelectCommand="SELECT [pname], [season], [theme], [duration], [location], [details], [subpack], [cost], [id] FROM [Packages] WHERE ([id] = @id)" 
