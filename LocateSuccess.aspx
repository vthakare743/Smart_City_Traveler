<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LocateSuccess.aspx.cs" Inherits="StudentLogin" %>
...
<div class="container">
    ...
    <div class="card">
        <h1 class="title">Locate Parking <asp:Image ID="Image1" Width="50px" ImageUrl="~/Images/locate.png" runat="server" /></h1>
        <div class="col-md-12">
            <form id="sign_in" runat="server" method="POST">
                <div>
                    <div class="form-line">
                        <asp:Image ID="Image2" Height="150px" Width="100%" ImageUrl ="~/Images/mapLocate.jpg" runat="server" />
                    </div>
                </div>
                <br />
                ...
                <span class="input-group-addon">
                    ...
                    <div class="form-line">
                        <asp:Label ID="lbltest" runat="server" Font-Size="Larger" ForeColor="Red" Text="Near By Parking Slots :"></asp:Label>
                    </div>
                </div>
                <br />
             ...
             <div class="form-line">
                 ...
                 <asp:GridView ID="GridView1" runat="server"  AutoGenerateColumns="False" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" DataSourceID="SqlDataSource1" ForeColor="Black" GridLines="Vertical" Width="100%">
                     ...
                     <Columns>
                         <asp:BoundField DataField="pname" HeaderText="Parking" SortExpression="Parking" />
                     </Columns>
                 ...
                 <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ParkingAppDBConnectionString %>" SelectCommand="SELECT [pname], [area] FROM [ParkingMaster] WHERE ([narea] LIKE '%' + @narea + '%')">
                     <SelectParameters>
