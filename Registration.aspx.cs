...
public partial class Registration : System.Web.UI.Page
{
    ...
    {
        ddlSem.Items.Clear();
        if (ddlYear.SelectedItem.ToString() == "1st Year")
        {
            ddlSem.Items.Add("Select Sem");
            ddlSem.Items.Add("1st Sem");
            ddlSem.Items.Add("2nd Sem");
        }
        if (ddlYear.SelectedItem.ToString() == "2nd Year")
        {
            ddlSem.Items.Add("Select Sem");
            ddlSem.Items.Add("3rd Sem");
            ddlSem.Items.Add("4th Sem");
        }
        if (ddlYear.SelectedItem.ToString() == "3rd Year")
        {
            ddlSem.Items.Add("Select Sem");
            ddlSem.Items.Add("5th Sem");
            ddlSem.Items.Add("6th Sem");
        }
        if (ddlYear.SelectedItem.ToString() == "4th Year")
        {
            ddlSem.Items.Add("Select Sem");
            ddlSem.Items.Add("7th Sem");
            ddlSem.Items.Add("8th Sem");
        }
    }
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        con.Open();
        cmd.Connection = con;
        cmd.CommandText = "insert into StudentMaster (sname,email,year,sem,category,sch,username,pwd) values(@name,@email,@year,@sem,@category,@sch,@username,@pwd)";
        ...
        cmd.Parameters.AddWithValue("@sch", ddlSch.SelectedItem.ToString());
        cmd.Parameters.AddWithValue("@username", txtUsername.Text);
        cmd.Parameters.AddWithValue("@pwd", pwd);
        int i = cmd.ExecuteNonQuery();
        if (i != null)
        {
            SendHTMLMail(txtemail.Text, txtUsername.Text, pwd);
